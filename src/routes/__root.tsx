...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AfterLight Studios" },
      { name: "description", content: "Editorial creative & growth studio for premium brands." },
      { name: "author", content: "AfterLight Studios" },
      { property: "og:site_name", content: "AfterLight Studios" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0A0A0A" },
      { property: "og:title", content: "AfterLight Studios" },
      { name: "twitter:title", content: "AfterLight Studios" },
